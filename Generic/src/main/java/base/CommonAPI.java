...
public class CommonAPI {
    ...
    public void setUp(@Optional("false") boolean useCloudEnv, @Optional("false")String cloudEnvName,
                      @Optional("OS X") String os, @Optional("10") String os_version,
                      @Optional("chrome-options") String browserName, @Optional("34") String browserVersion,
                      @Optional("http://www.amazon.com") String url)throws IOException {

        Properties properties=loadProperties();
        String browserstack_username= properties.getProperty("BROWSERSTACK.username");
        String browserstack_accesskey= properties.getProperty("BROWSERSTACK.accesskey");
        String saucelabs_username= properties.getProperty("SAUCELABS.username");
        String saucelabs_accesskey= properties.getProperty("SAUCELABS.accesskey");
